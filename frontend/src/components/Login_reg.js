    ...
    <div className='body'>
      ...
      <div className="section">
        ...
        <div className="container">
          ...
          <h1 id='blaka' >RECRUITMENT WEBSITE</h1>
          <br/>
          
          <h4 style={{color:'white'}}><i class="bi bi-search"></i>  Find The Best Talent For Your Company.</h4>
          <hr style={{color:'primary'}}/>
            <h4 style={{color:'white'}}><i class="bi bi-briefcase"></i>    Find The Job That Fits Your Life.</h4>
            </div>
            <div className="col-6 text-center align-self-center py-5">
